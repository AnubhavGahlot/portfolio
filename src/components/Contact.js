      ...
      <div className="md:mx-6 flex flex-col flex-wrap md:flex-row justify-between">
        <div className="md:w-6/12 md:px-0 p-5 my-5">
          ...
          <div className="flex flex-row flex-wrap mt-7">
            <div className="mr-4">
              <a
                href="https://www.linkedin.com/in/anubhavgahlot/"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="mr-4">
              <a
                href="https://x.com/anubhav_gahlot"
                target="_blank"
                rel="noreferrer"
              >
                <span className="mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm">
            ...
            <div className="mr-4">
              <a
                href="https://github.com/AnubhavGahlot"
                target="_blank"
                rel="noreferrer"
              >
                <span className="mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm">
          ...
          <a href="./Anubhav_Gahlot.pdf" download>
            <button
              type="submit"
        ...
        <div className="bg-gray px-5 md:py-8 sm:p-8 my-2 md:rounded-lg shadow-lg  justify-between w-full h-content  md:w-6/12 ">
          <form
            ...
            name="contact"
            method="post"
            action="anubhavgahlot0@gmail.com"
